...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(IMPLICIT_NOTHING_AS_TYPE_VARIABLE, "One of the type variables was implicitly inferred to Nothing. Please, specify type arguments explicitly to hide this warning.");
