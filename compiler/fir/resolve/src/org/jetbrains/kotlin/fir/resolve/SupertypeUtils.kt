...
fun ConeClassLikeType.projection(useSiteSession: FirSession): ConeClassLikeType {
...
tailrec fun ConeClassLikeType.computePartialExpansion(): ConeClassLikeType? {
    return when (this) {
...
tailrec fun ConeClassLikeSymbol.collectSuperClasses(useSiteSession: FirSession, list: MutableList<ConeClassLikeType>) {
    when (this) {
        is FirClassSymbol -> {
            val superClassType =
                fir.superConeTypes
...
fun ConeClassLikeSymbol.collectSuperTypes(useSiteSession: FirSession, list: MutableList<ConeClassLikeType>, deep: Boolean) {
    when (this) {
        is FirClassSymbol -> {
            val superClassTypes =
