...
class FirSupertypeResolverTransformer : FirAbstractTreeTransformer() {
    ...
    override fun transformRegularClass(regularClass: FirRegularClass, data: Nothing?): CompositeTransformResult<FirDeclaration> {
        val transformedClass = resolveSupertypesOrExpansions(regularClass) as FirRegularClass
    ...
    private class ResolveSuperTypesTask(
        ...
        override fun transformRegularClass(regularClass: FirRegularClass, data: Nothing?): CompositeTransformResult<FirDeclaration> {
            ...
            val transformedClass = withScopeCleanup {
                ...
                val transformer = FirSpecificTypeResolverTransformer(towerScope, FirPosition.SUPER_TYPE_OR_EXPANSION)
            ...
            return resolveInnerClassesSupertypes(transformedClass, data)
        }
        ...
        private fun resolveInnerClassesSupertypes(
