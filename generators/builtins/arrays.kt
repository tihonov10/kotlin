...
class GenerateArrays(out: PrintWriter) : BuiltInsSourceGenerator(out) {
    ...
    override fun generateBody() {
        for (kind in PrimitiveType.values()) {
            ...
            out.println("     *")
            out.println("     * If the [index] is out of bounds of this array, the result is unspecified on the JS")
            out.println("     * and throws an [IndexOutOfBoundsException] on other platforms.")
            out.println("     */")
